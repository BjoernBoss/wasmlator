...
namespace trans::detail {
	...
	/*
	*	Core-Imports:
	*		void main.main_lookup(i64 addr, i32 size, i32 usage);
	...
	*		i64 mem_read(i64 addr, i32 size);
	*		void mem_write(i64 addr, i32 size, i64 value);
	*		i64 mem_code(i64 addr, i32 size);
	*
	*	Core-Exports to Body:
	*		i32 mem_lookup_read(i64 addr, i32 size, i32 cache);
	*		i32 mem_lookup_write(i64 addr, i32 size, i32 cache);
	*		i32 mem_lookup_code(i64 addr, i32 size, i32 cache);
	*
	*	Body-Imports:
	*		i32 core.lookup_read(i64 addr, i32 size, i32 cache);
	*		i32 core.lookup_write(i64 addr, i32 size, i32 cache);
	*		i32 core.lookup_code(i64 addr, i32 size, i32 cache);
	*/
