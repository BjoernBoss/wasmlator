...
em_main := $(em) --no-entry -sERROR_ON_UNDEFINED_SYMBOLS=0 -sWARN_ON_UNDEFINED_SYMBOLS=0 -sWASM_BIGINT -sALLOW_MEMORY_GROWTH -sSTANDALONE_WASM\
 -sEXPORTED_FUNCTIONS=_main_initialize,_main_core_loaded,_main_terminate,_main_not_decodable,_main_resolve,_main_flushed,_main_block_loaded,_main_lookup,_main_result_address,_main_result_physical,_main_result_size,_main_invoke_void,_main_invoke_param
